...
mixin _$HomePageState {
  ...
  Status get productFetchStatus => throw _privateConstructorUsedError;
...
class _$HomePageStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? productFetchStatus = freezed,
    ...
    return _then(_value.copyWith(
      products: products == freezed
          ...
          : products // ignore: cast_nullable_to_non_nullable
              as List<Product>,
      productFetchStatus: productFetchStatus == freezed
          ? _value.productFetchStatus
          : productFetchStatus // ignore: cast_nullable_to_non_nullable
              as Status,
...
class _$_HomePageState with DiagnosticableTreeMixin implements _HomePageState {
  const _$_HomePageState(
      ...
      this.productFetchStatus = Status.init,
      this.errorMessage})
      : _products = products;
  ...
  @override
  @JsonKey()
  final Status productFetchStatus;
  @override
  final String? errorMessage;

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'HomePageState(products: $products, productFetchStatus: $productFetchStatus, errorMessage: $errorMessage)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('productFetchStatus', productFetchStatus))
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.productFetchStatus, productFetchStatus) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(productFetchStatus),
